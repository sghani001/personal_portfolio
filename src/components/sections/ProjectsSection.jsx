...
function PersonalProjectCard({ project, isActive, onOpen }) {
  return (
    ...
    >
      <div style={{ width: "100%", aspectRatio: "16/10", flexShrink: 0 }}>
      ...
      <div style={{ padding: "18px 22px 22px", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        {isActive && <p style={{ fontSize: 11, color: C.copper, marginTop: "auto", fontFamily: "'JetBrains Mono',monospace" }}>Click for details →</p>}
      </div>
    </div>
  );
}
